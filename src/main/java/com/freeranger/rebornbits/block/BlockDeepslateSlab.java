...
public class BlockDeepslateSlab extends ElementsRebornBits.ModElement {
	@GameRegistry.ObjectHolder("rebornbits:deepslateslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("rebornbits:deepslateslab_double")
	public static final Block block_slab_double = null;
	public BlockDeepslateSlab(ElementsRebornBits instance) {
		super(instance, 32);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("deepslateslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("deepslateslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("rebornbits:deepslateslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("deepslateslab");
