...
public class BlockDeepslateBrickSlab extends ElementsRebornBits.ModElement {
	@GameRegistry.ObjectHolder("rebornbits:deepslatebrickslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("rebornbits:deepslatebrickslab_double")
	public static final Block block_slab_double = null;
	public BlockDeepslateBrickSlab(ElementsRebornBits instance) {
		super(instance, 42);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("deepslatebrickslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("deepslatebrickslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("rebornbits:deepslatebrickslab", "inventory"));
	}
