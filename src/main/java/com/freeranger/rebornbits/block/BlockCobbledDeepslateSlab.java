...
public class BlockCobbledDeepslateSlab extends ElementsRebornBits.ModElement {
	@GameRegistry.ObjectHolder("rebornbits:cobbleddeepslateslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("rebornbits:cobbleddeepslateslab_double")
	public static final Block block_slab_double = null;
	public BlockCobbledDeepslateSlab(ElementsRebornBits instance) {
		super(instance, 34);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("cobbleddeepslateslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("cobbleddeepslateslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("rebornbits:cobbleddeepslateslab", "inventory"));
	}
