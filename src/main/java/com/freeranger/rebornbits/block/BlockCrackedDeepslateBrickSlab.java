...
public class BlockCrackedDeepslateBrickSlab extends ElementsRebornBits.ModElement {
	@GameRegistry.ObjectHolder("rebornbits:crackeddeepslatebrickslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("rebornbits:crackeddeepslatebrickslab_double")
	public static final Block block_slab_double = null;
	public BlockCrackedDeepslateBrickSlab(ElementsRebornBits instance) {
		super(instance, 49);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("crackeddeepslatebrickslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("crackeddeepslatebrickslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("rebornbits:crackeddeepslatebrickslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("crackeddeepslatebrickslab");
